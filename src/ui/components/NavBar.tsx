...
export default function NavBar() {
    ...
    return (
        <>
            ...
            >
                <div className="flex justify-evenly items-center w-full min-h-full">
                    ...
                    <div className="flex w-full justify-end gap-2 md:gap-4 order-3 px-(--gutter) lg:px-(--gutter-md)">
                        ...
                        <Link
                            href={"/bag"}
                            className="relative p-2 [border-radius:50%] hidden sm:block"
                            title="Bag"
                            aria-label="Bag"
                        >
                        ...
                        <button className="p-2 [border-radius:50%] hidden sm:block">
                            <IoPersonOutline
                                className="hover:scale-125 transition"
                                title="Account"
                                aria-label="Account"
            ...
            <SlideDownMenu predicate={isMenuOpen} predicateSetter={setIsMenuOpen}>
